...
stateJogoBT = namedtuple('stateJogoBT', 'to_move, board, last_move')
...
class JogoBT_24(Game):
    ...
    def __init__(self, initial = None):
        ...
        self.initial = stateJogoBT(to_move = 1, board = board, last_move='None')
    ...
    def result(self, state, move):
        ...
        newBoard.pop(aux1)
        if state.to_move == 1:
            return stateJogoBT(to_move = 2, board = newBoard, last_move=move) 
        
        return stateJogoBT(to_move = 1, board = newBoard, last_move=move) 
